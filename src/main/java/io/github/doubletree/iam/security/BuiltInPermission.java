package io.github.doubletree.iam.security;
...
public enum BuiltInPermission {
    ...
    PERMISSIONS_WRITE("iam.permissions.write", "Manage permission catalog", "Manage permission catalog entries outside the reserved iam.* namespace.", "Permissions", true, false, false),
    RESOURCE_SERVERS_READ("iam.resource-servers.read", "Read applications", "View tenant-owned applications and resource server permissions.", "Applications", true, true, true),
    RESOURCE_SERVERS_WRITE("iam.resource-servers.write", "Manage applications", "Create and update tenant-owned applications and resource server permissions.", "Applications", true, true, false),
