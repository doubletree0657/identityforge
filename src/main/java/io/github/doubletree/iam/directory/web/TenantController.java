...
import io.github.doubletree.iam.directory.web.dto.CreateTenantRequest;
import io.github.doubletree.iam.shared.web.PageResponse;
import io.github.doubletree.iam.directory.web.dto.TenantResponse;
import io.github.doubletree.iam.directory.web.dto.UpdateTenantRequest;
...
public class TenantController {
    ...
    public TenantResponse createTenant(@Valid @RequestBody CreateTenantRequest request) {
        Tenant tenant = tenantApplicationService.createTenant(request.name(), request.slug());
