...
import io.github.doubletree.iam.directory.web.dto.CreateGroupRequest;
import io.github.doubletree.iam.directory.web.dto.GroupResponse;
import io.github.doubletree.iam.shared.web.PageResponse;
import io.github.doubletree.iam.directory.web.dto.RoleResponse;
import io.github.doubletree.iam.directory.web.dto.UpdateGroupRequest;
...
public class GroupController {
    ...
    public GroupResponse createGroup(@Valid @RequestBody CreateGroupRequest request) {
        Group group = groupApplicationService.createGroup(
                request.tenantId(), request.name(), request.displayName(), request.description());
