...
public class AdminApiAuthorizationManager implements AuthorizationManager<RequestAuthorizationContext> {
    ...
    private static final String ADMIN_AUDIENCE = "identityforge-admin-api";
    ...
    public AuthorizationDecision check(
        ...
        if (audiences == null || !audiences.contains(ADMIN_AUDIENCE)) {
            return new AuthorizationDecision(false);
        }
